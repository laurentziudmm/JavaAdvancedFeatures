...
public class ExerciceTwo {
     ...
     * metoda ce scade viteza vehiculului cu valoarea primita prin parametrul metodelClasa are o metoda abstracta:
     ...
     * Truck  truck = newTruck(); truck.changeGear(2); truck.speedUp(3);
     * truck.applyBrakes(1); truck.printStates(); Bus bus = newBus();
     * bus.changeGear(1); bus.speedUp(4); bus.applyBrakes(3); bus.printStates();
     * 3.A swimmer can swim and breath.A walker can walk and breath.
     ...
     * d.Creaza clasa Swimmer ce implementeaza interfetele Swim si Breath si implementeaza metodele. I
     * mplementarea trebuie sa afiseze un mesaj sugestiv la consola.
     * e.Creaza clasa Walker ce implementeaza interfetele Walk si Breath si implementeaza metodele.
     * Implementarea trebuie sa afiseze un mesaj sugestiv la consola.
     * f.In metoda main() instantiaza un obiect de tipul Walker si un obiect de tipulSwimmer.
